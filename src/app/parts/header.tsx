        ...
        <header className="text-xl bg-white w-screen w-full w-screen shadow-[0px_21px_19px_-7px_rgba(0,_0,_0,_0.1)]">
            <nav className="flex justify-between items-center mx-auto px-2 xl:px-10 lg:px-4 relative">
                ...
                <div className="flex gap-4 items-center">
                    <Link href="#" className="bg-[#ffbd59] hover:bg-[#e3aa4f] text-nowrap p-3 rounded-full hidden xs:flex xs:items-center xs:gap-2">
                        <FaAward className="text-3xl" />
                        <span><b>Prêmio Nexus</b></span>
                        <span className="hidden xl:block">2024</span>
                    </Link>
                    <Link href="#" className="bg-[#dc0000] hover:bg-[#bd4444] text-nowrap text-white p-3 rounded-full hidden sm:flex sm:gap-1 sm:items-center outline hover:outline-4 hover:outline-red-400">
